...
Twelve mini-games, each targeting a different visual skill. All are designed for
...
| Railway Crossing | Smooth pursuit + selective attention — tap trains, let cars pass |
| Metro Memory | Visual memory and sequential fixation — repeat the lit-station route |
